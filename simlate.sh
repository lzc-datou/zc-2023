...
sleep 5
{
gnome-terminal --tab "ardupilot/ArduPlane" -- bash -c "cd /home/lzc/ardupilot/Tools/autotest;sim_vehicle.py -v ArduPlane -f gazebo-zephyr -L Hanan"
}& 
sleep 3
{
gnome-terminal --tab "gazebo" -- bash -c "cd /home/lzc/ardupilot_gazebo;gazebo --verbose -s libgazebo_ros_api_plugin.so ./worlds/my_simulation.world"
}& 
sleep 3
{
