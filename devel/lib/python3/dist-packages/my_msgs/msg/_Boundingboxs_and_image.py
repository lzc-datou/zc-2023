...
"""autogenerated by genpy from my_msgs/Boundingboxs_and_image.msg. Do not edit."""
import codecs
import sys
...
class Boundingboxs_and_image(genpy.Message):
  _md5sum = "b8d6383478d3cb0299e85875bbaf9e11"
  _type = "my_msgs/Boundingboxs_and_image"
...
"""
  __slots__ = ['header','bounding_boxs','image_list']
  _slot_types = ['std_msgs/Header','my_msgs/Bounding_box[]','sensor_msgs/Image[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,bounding_boxs,image_list
    ...
    """
    if args or kwds:
      super(Boundingboxs_and_image, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.bounding_boxs is None:
        self.bounding_boxs = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.bounding_boxs)
      buff.write(_struct_I.pack(length))
      for val1 in self.bounding_boxs:
        _x = val1.Class
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_f4q().pack(_x.conf, _x.x1, _x.y1, _x.x2, _x.y2))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.conf, _x.x1, _x.y1, _x.x2, _x.y2,) = _get_struct_f4q().unpack(str[start:end])
        self.bounding_boxs.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.image_list = []
...
def _get_struct_f4q():
    global _struct_f4q
    if _struct_f4q is None:
        _struct_f4q = struct.Struct("<f4q")
    return _struct_f4q
